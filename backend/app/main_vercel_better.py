...
# Conditionally handle database initialization based on environment
if not os.getenv("VERCEL"):
    # Only run database initialization in non-Vercel environments
    ...
    # For Vercel, skip the lifespan manager to avoid database issues
    app = FastAPI(
        title="Todo API",
        description="Backend API for the Todo Web Application",
        version="1.0.0"
